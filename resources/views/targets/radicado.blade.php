                                    ...
                                    <div class="card" style="width: 100%;">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <form method="POST"
                                                        action="{{ route('Radicado.update', $nC->id) }}"
                                                    ...
                                                    @foreach ($estado as $est)
                                                        @if ($est->id == $nC->status)
                                                            @switch($nC->status)
                                                                ...
                                                                @case(5)
                                                                    <span
                                                                        class="badge badge-pill badge-success">Aceptado</span>
                                                                @break
                                                            @endswitch
                                                        @endif
                                                    @endforeach
                                                                    ...
                                                                    <div class="tab-pane fade"
                                                                        ...
                                                                        <div class="row">
                                                                            @forelse ($files as $file)
                                                                                ...
                                                                                @endif
                                                                            @empty
                                                                                <p>No hay archivos para esta respuesta
                                                                                </p>
                                                                            @endforelse
